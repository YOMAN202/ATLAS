...
export default function SupplierRiskDashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <h1 className="text-xl font-semibold">Planning — Supplier Risk</h1>
            ...
            <KpiCard
              ...
              note={
                summary.data.scoring_weights
                  ? `weights: ${JSON.stringify(summary.data.scoring_weights)}`
      ...
      <div>
        <div className="mb-2 flex items-center justify-between">
          <h2 className="text-sm font-medium text-slate-500">Supplier Risk Detail</h2>
          <select
