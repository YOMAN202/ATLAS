    ...
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        {calibration.status === "ready" && !activeCalibration && (
          <p className="text-sm text-ink-muted">No calibration data for this prediction type.</p>
        )}
      </div>

      <div>
        <div className="mb-2 flex items-center justify-between">
          <h2 className="text-sm font-medium text-ink-secondary">Service-Level Detail</h2>
