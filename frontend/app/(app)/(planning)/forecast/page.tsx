...
export default function ForecastDashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <h1 className="text-headline font-semibold text-ink-primary">Planning — Demand Forecast</h1>
      ...
      <div>
        <div className="mb-2 flex items-center justify-between">
          <h2 className="text-sm font-medium text-ink-secondary">Forecast Detail</h2>
          <select
            value={grainType}
            onChange={(e) => {
