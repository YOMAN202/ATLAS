...
const BALANCING_COLOR: Record<string, string> = {
  reorder_now: "text-status-critical",
  adequate: "text-status-good",
  excess_inventory: "text-status-warning",
};
    ...
    <div className="flex flex-col gap-6">
            ...
            <div className="mt-2 overflow-x-auto">
              <table className="w-full text-sm">
                <thead className="bg-surface-inset">
                  <tr>
                    <th className="px-3 py-2 text-left font-medium text-ink-secondary">Target</th>
                    <th className="px-3 py-2 text-left font-medium text-ink-secondary">Achieved</th>
      ...
      <div>
        <div className="mb-2 flex items-center justify-between">
          <h2 className="text-sm font-medium text-ink-secondary">Inventory Policy Detail</h2>
          <select
            value={balancing}
            onChange={(e) => {
