...
# + 8 Phase 7 decision-support tables (Module A: ds_model_registry,
...
# ds_inventory_policy, ds_policy_sensitivity — docs/phase7-architecture.md
# §5, docs/phase7-module-c-completion.md, docs/phase7-module-d-completion.md,
# docs/phase7-module-b-completion.md; the 6 feature views across the
# Module A/C DDL passes are VIEWs, not BASE TABLEs, so they don't count
# here — Modules B/D deliberately use parameterized SQL instead of static
# views, since their "as of cutoff" walk-forward logic needs a bind
...
# running total across phases, not Phase 4 alone. File count (31) exceeds
# table count (27) by 4, all pre-existing-pattern files that add no new
